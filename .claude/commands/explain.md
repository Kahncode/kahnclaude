---
name: explain
description: Explain code in detail — what it does, how it works, and why. Accepts a file path, line range, function/class name, or no argument for the most recently discussed file.
scope: project
---
