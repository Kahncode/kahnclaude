...
3. **Trace dependencies** — check imports, module boundaries, build/config files
...
- Changes to shared/public interfaces
- Cross-module dependencies
- State synchronization or concurrency changes
